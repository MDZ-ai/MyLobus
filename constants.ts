import { Leader, TransportRoute, StockData, CountryService, Parcel, UtilityContract, InsurancePolicy, Message, Document, NewsItem, CryptoAsset } from './types';
...
const MOCK_CRYPTO: CryptoAsset[] = [
    { symbol: 'BTC', name: 'Bitcoin', amount: 0.45, valueUSD: 64200, change24h: 2.4, color: 'bg-orange-500' },
    { symbol: 'ETH', name: 'Ethereum', amount: 4.2, valueUSD: 3450, change24h: -1.2, color: 'bg-indigo-500' },
    { symbol: 'LBS', name: 'Lobus Coin', amount: 15000, valueUSD: 1.20, change24h: 15.4, color: 'bg-yellow-400' },
];

// Updated Image URLs to be more robust
export const MOCK_NEWS: NewsItem[] = [
    { id: 'n1', category: 'Economía', title: 'El Banco Central Lobus anuncia subida de tipos de interés al 4%.', time: 'Hace 2h', image: 'https://images.unsplash.com/photo-1611974765270-ca12586343bb?q=80&w=400&auto=format&fit=crop', color: 'bg-yellow-100 text-yellow-700' },
    { id: 'n2', category: 'Tecnología', title: 'País Pingüino inaugura el servidor de hielo cuántico.', time: 'Hace 5h', image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?q=80&w=400&auto=format&fit=crop', color: 'bg-cyan-100 text-cyan-700' },
    { id: 'n3', category: 'Transporte', title: 'Nuevo HyperLoop conectará País Oso con la capital en 10 min.', time: 'Ayer', image: 'https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?q=80&w=400&auto=format&fit=crop', color: 'bg-purple-100 text-purple-700' },
    { id: 'n4', category: 'Sucesos', title: 'Descubren nueva especie de Micelio luminoso en País Hongo.', time: 'Ayer', image: 'https://images.unsplash.com/photo-1535376472810-5d229c65da09?q=80&w=400&auto=format&fit=crop', color: 'bg-green-100 text-green-700' },
];
